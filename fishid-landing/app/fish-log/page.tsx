    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#0e496c] px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/fish-log" className="text-white text-[#2e9eb3] font-medium">
              Fish Log
            </Link>
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center py-20">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="mb-8">
            <Fish className="w-24 h-24 text-[#2e9eb3] mx-auto mb-6" />
            <h1 className="text-4xl md:text-5xl font-bold text-[#0d2a50] mb-4">Fish Log</h1>
            <p className="text-xl text-[#138094] mb-8">Your personal collection of identified fish species</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-12 shadow-lg border border-gray-100 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              We're working hard to bring you an amazing fish logging experience. Soon you'll be able to save, organize,
              and share all your fish identifications in one beautiful place.
            </p>
            ...
            <div className="space-y-4 text-left bg-gray-50 rounded-xl p-6 mb-8">
              ...
              <div className="space-y-2 text-gray-700">
                <div className="flex items-center space-x-3">
                  ...
                  <span>Save your identified fish species</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#2e9eb3] rounded-full"></div>
                  <span>Track your diving locations</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#2e9eb3] rounded-full"></div>
                  <span>Share your discoveries with friends</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-[#2e9eb3] rounded-full"></div>
                  <span>Export your fish log data</span>
                </div>
              </div>
            </div>
